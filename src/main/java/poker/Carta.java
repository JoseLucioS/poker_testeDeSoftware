...
public class Carta implements Comparable<Carta> {
	...
	public int compareTo(final Carta outraCarta) {
		int valorCarta1 = this.valor == 1 ? 14 : this.valor;
        int valorCarta2 = outraCarta.valor == 1 ? 14 : outraCarta.valor;
		
		//final int comparacao = this.valor.compareTo(outraCarta.getValor());
		final int comparacao = Integer.compare(valorCarta1, valorCarta2);
		if (comparacao == 0) {
